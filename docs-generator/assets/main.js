...
(() => {
	...
	var De = (t, e, r, n) => {
		if ((e && typeof e == 'object') || typeof e == 'function')
			for (let i of Oe(e))
				!_e.call(t, i) && i !== r && ue(t, i, { get: () => e[i], enumerable: !(n = Pe(e, i)) || n.enumerable });
		return t;
	};
	var Fe = (t, e, r) => (
		(r = t != null ? Ce(Re(t)) : {}),
...
`,
			...
			(t.Vector = function (e) {
				...
				(t.Vector.prototype.dot = function (e) {
					for (
						var r = 0, n = this.elements, i = e.elements, s = n.length, o = i.length, a = 0, u = 0, l = 0, h = 0;
						l < s && h < o;

					)
						(a = n[l]),
							(u = i[h]),
							a < u ? (l += 2) : a > u ? (h += 2) : a == u && ((r += n[l + 1] * i[h + 1]), (l += 2), (h += 2));
					return r;
				}),
			...
			(t.TokenSet = function () {
				...
				(t.TokenSet.prototype.intersect = function (e) {
					for (var r = new t.TokenSet(), n = void 0, i = [{ qNode: e, output: r, node: this }]; i.length; ) {
						n = i.pop();
						for (
							var s = Object.keys(n.qNode.edges), o = s.length, a = Object.keys(n.node.edges), u = a.length, l = 0;
							l < o;
							l++
						)
