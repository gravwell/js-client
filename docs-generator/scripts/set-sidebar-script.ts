 ...
 *
 * @param page will give us the information about the page, that will be used as
 *   a name and as a link
 * @param index will be a number to not cause conflit between the
 *   sidebarElements
