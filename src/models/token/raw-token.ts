...
export interface RawToken {
	...
	/**
	 * An optional description of the created token. Might return null or an empty
	 * string.
	 *
	 ...
	 *
	 * @example 2032-04-23T18:25:43.511Z
	 */
	createdAt: string;

	/**
	 * Optional DateTime in RFC3339 indicating that the token should automatically
	 * expire.
	 *
	 * WARNING: If this property is not included (or is included and set to
	 * `"0001-01-01T00:00:00Z"`), that means it won't expire
	 *
